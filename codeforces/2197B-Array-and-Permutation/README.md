...
Choose an index i (1 ≤ i  \lt  n) and perform one of two replacements: 
...
The first line of each test case contains a single integer n (2 ≤ n ≤ 2 ⋅ 10^{5}) — the length of the array and the permutation.

The second line of each test case contains n integers p_1, p_2, …, p_n (1 ≤ p_{i} ≤ n) — the elements of the permutation.

The third line of each test case contains n integers a_1, a_2, …, a_n (1 ≤ a_{i} ≤ n) — the elements of the array.
